export const en = {
  ...
  documents: {
    ...
    subtitle:
      "Upload your documents, track processing status, extract structured data and chat with content using a modern AI workspace.",
    ...
    librarySubtitle: "Browse, manage and open your processed files.",
